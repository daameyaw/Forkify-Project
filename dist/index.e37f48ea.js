...
var _webImmediateJs = require("core-js/modules/web.immediate.js"); // window.addEventListener(showRecipe);
...
const loadRecipe = async function(id) {
    try {
        const respond = await fetch(`https://forkify-api.herokuapp.com/api/v2/recipes/${id}`);
